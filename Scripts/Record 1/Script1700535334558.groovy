...
WebUI.sendKeys(findTestObject('Object Repository/Page_Sign in to msb/input_password'), Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Object Repository/Page_Digi-Lending/a_Yu cu cn x l'))

WebUI.click(findTestObject('Object Repository/Page_Digi-Lending/span_p-toast-icon-close-icon pi pi-times ng_d4a75d'))
...
WebUI.click(findTestObject('Object Repository/Page_Digi-Lending/i_icon-msb-search-fill'))

WebUI.click(findTestObject('Object Repository/Page_Digi-Lending/div_ang x l'))

WebUI.click(findTestObject('Object Repository/Page_Digi-Lending/input_w-100 form-control ng-untouched ng-pr_9fbbf5'))

WebUI.click(findTestObject('Object Repository/Page_Digi-Lending/button_To h s'))

WebUI.click(findTestObject('Object Repository/Page_Digi-Lending/i_icon-msb-play1'))
